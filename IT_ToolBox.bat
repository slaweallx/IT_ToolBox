@echo off
chcp 65001 >nul
title IT TOOLBOX - CENK KARAKOL - ALİ ÇÖMEZ

:menu
cls
echo ============================================
echo          IT TOOLBOX Ver 1.0 - CENK KARAKOL - ALİ ÇÖMEZ
echo ============================================
...
echo 41. Bilgisayar Adını Değiştir
echo 42. IP Alt Ağını Göster
echo 43. Ağ Bağlantılarını Etkinleştir/Kapat
echo 44. Aktif Ağ Bağlantılarını Göster
echo 45. Hizmetleri Yönet (Başlat/Durdur/Yeniden Başlat)
echo 46. Olay Günlüklerini Görüntüle
echo 47. Kayıt Defterini Yedekle
echo 48. Kayıt Defterini Geri Yükle
echo 49. Sistem Performansını İzle
echo 50. Paylaşılan Klasörleri Listele
echo 51. Çıkış Yap
echo ============================================
set /p choice=Bir işlem numarası seçin (Çıkmak için 51 girin): 
...
if "%choice%"=="41" (
    ...
    echo 41 numarasıyla daha önce eklenmiş seçenekler bulunmamaktadır.
    pause
)
...
REM Çıkış için kontrol (Alternatif olarak)
REM if /i "%choice%"=="X" (
REM     exit
REM )
